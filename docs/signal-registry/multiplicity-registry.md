...
| `CF-VOLDIR-001/HYP-D7` | SPDR-020 | Same question on the SPDR-014 E-TOUCH/E-CLOSE event object under direction-aware capture; band selectivity is measured on every cell and `p_event` never filters eligibility | 0 | **REGISTERED 2026-07-25**; wording clarified by operator 2026-07-29; start-gated on the SPDR-018 reflection |
