...
| `CF-AVWAP-001/PI-EXIT` (37-cell training) — **EXP-045** | B | Per cell: FH {2,3,4,6,8,11,16,23} and MAD-band (P6 grid) exits trained on TRAIN; n-neighbour stability plane (k=1, interior-only); tunability + P4 floor → membership. | 0 / 0 | **COMPLETE 2026-06-11 — TRAINING_DELIVERED, EMPTY MEMBERSHIP, audit PASS** | **G2 adjudicated FAIL 2026-06-11** ([G2-gate-review.md](../../archive/chapter-01-price-geometry-referee/experiments-docs/checkpoints/2026-06-11-011-per-instrument-foundation/G2-gate-review.md)): 0/37 members (35 NON_TUNABLE — 42 `endpoint_argmax` / 30 `flat_plane` of 74 family-cells; 2 FLOOR_FAIL with negative plateaus: EURUSD-1h FH(3) −3.45 bps, US500-2h MAD(1.0) −0.37) vs P5 ≥5 cells over ≥3 instruments → **FOUNDATION_NON-TUNABLE, no TEST spent**. Net medians −5 to −7 bps everywhere; gross proxy positive 31/37 — costs consume the edge. Negative training result retained (file drawer). |
...
[`G-019-gate-review.md`](../../archive/chapter-01-price-geometry-referee/experiments-docs/checkpoints/2026-06-22-019-family-selection-availability-screen/G-019-gate-review.md).
...
**Governing design:** [`design.md`](../../archive/chapter-01-price-geometry-referee/experiments-docs/checkpoints/2026-06-22-019-family-selection-availability-screen/design.md)
...
extended GREEN.
**Governing design:** [`design.md`](../../archive/chapter-01-price-geometry-referee/experiments-docs/checkpoints/2026-06-23-020-mean-reversion-entry-availability/design.md)
...
**Governing design:** [`design.md`](../../archive/chapter-01-price-geometry-referee/experiments-docs/checkpoints/2026-06-23-021-mr-fade-capture-geometry/design.md)
...
**Slots:** checkpoint-017 consumed **0** slots. `HYP-D5` is now COMPLETE across both universes
(SPDR-018 SUPPORTED, SPDR-018B PARTIALLY SUPPORTED), having consumed 0 slots and 0 counted TEST
reads. The two later capture-axis registrations also consumed 0 slots and 0 counted TEST reads
before being withdrawn and permanently voided on 2026-07-30. The capture axis is unregistered.
...
| `CF-LIQSWP-001/HYP-001` | EXP-101 | Do level-family/configuration significance strata differ in later swing outcomes? | 0 | **INCONCLUSIVE — winner-only slice (2026-09-02).** Checkpoint 019 closed; family retired characterised-not-tradable. |
| `CF-LIQSWP-001/HYP-002` | EXP-102 | Does previous completed raid count change later swing outcomes? | 0 | **COMPLETED — descriptive ATR/strong-move, winner-only (2026-09-02).** Checkpoint 019 closed. |
| `CF-LIQSWP-001/HYP-003` | EXP-103 | Are defined tight value gaps associated with different later outcomes? | 0 | **INCONCLUSIVE — winner-only slice (2026-09-02).** Checkpoint 019 closed. |
| `CF-LIQSWP-001/HYP-004` | EXP-104 | Does causal volatility regime describe raid frequency and outcome quality? | 0 | **COMPLETED — descriptive ATR/strong-move, winner-only (2026-09-02).** Duration and start-rate do not confirm. Checkpoint 019 closed. |
| `CF-LIQSWP-001/HYP-005` | deferred | Are breakout-causing levels uniquely significant? | 0 | **NEVER RUN.** Deferred at family retirement. |
| `CF-LIQSWP-001/VAL-009` | VAL-009 | Selection/lifecycle census of EXP-100 | 0 | **COMPLETED — characterisation (2026-09-02).** Completed ~8%; confirmed-not-primary ~44%. |
| `CF-LIQSWP-001/VAL-010` | VAL-010 | Later-swing anatomy | 0 | **COMPLETED — characterisation (2026-09-02).** Repeat drop is first-push/surplus, not duration. |
| `CF-LIQSWP-001/VAL-011` | VAL-011 | TPO geometry, regime, all-raid frequency | 0 | **COMPLETED — characterisation (2026-09-02).** Start-rate and duration do not confirm leftover ATR. |
