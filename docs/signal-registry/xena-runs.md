...
|---|---|---|---|---|---|---|---|---|---|---|
| XENA-EPSOSC-001 | 2026-07-17 | CF-EPSOSC-001 VOLARM binding (464) | abbb1842 | 2021-06-29T06:53:00+00:00 → 2022-06-24T23:19:48+00:00 | **2148** (search) + certify | **12** (12/12 distinct restart terminals) | — (top-1 REJECT-class) | **0/2** | **NOT SUPPORTED (analyst recommendation; superseded by XENA-EPSOSC-002).** Formal top-1 REJECT-class (leak tripwire collapse 0.395 < 0.5); only survivor (#3 AKRO RET_ANCHOR dual short) net-passes at seed=42 / tripwire 0.612 but on a **directional-drift pedestal**, single-symbol (AKRO), seed-fragile LCB (gross LCB range −3.7…+31 straddles 0, net 1/10), and a **search band predating the VOLARM mass**. No universe-level availability claim supportable. Motivated the mass-aligned multi-symbol re-run XENA-EPSOSC-002 (which reproduced the drift pedestal → also NOT SUPPORTED). No TEST gate; holdout sealed. Analysis `python/experiments/XENA-EPSOSC-001/analysis.md` | **RETIRED — REFUTED** (operator-signed 2026-07-19, checkpoint-013) |
| XENA-EPSOSC-002 | 2026-07-18 | CF-EPSOSC-001 VOLARM RET_ANCHOR binding (152; 19 sym) | abbb1842 | 2022-07-01T00:00:00Z → 2023-01-31T00:00:00Z | **1898** (search) + certify | **12** | 1 (K≥3 post-rank; 4 sym) — **gate FAIL** | **0/2** | **NOT SUPPORTED (operator verdict 2026-07-18).** Mass-aligned RET_ANCHOR cross-symbol successor to 001. Estimand gate 152/152 PASS. AMENDMENT-1 correctly excluded the two 2-symbol raw finalists (1000BONK×2+AKRO medianF 58.5; AKRO+LEVER −23). Certified 4-symbol subset (10000LADYS_L, AKRO_S, LEVER_L, STMX_S): **stage-2 gross LCB −68.2 (net −102.1), 62 legs — DOES NOT CERTIFY**; **derangement tripwire FAIL** (raw collapse 0.091, drift-adjusted 0.135, live 95 < matched-drift twin P95 131.5). Per-symbol AKRO-concentrated (450 bps/10 legs carries pool; STMX −60, LEVER ~0) = **001 drift pedestal reproduced**; edge is volatility-window clustering, not arm→reversion signal. No counted TEST read; holdout SEALED. Report `python/experiments/XENA-EPSOSC-002/report.md` | **RETIRED — REFUTED** (operator-signed 2026-07-19, checkpoint-013) |
| XENA-HTFCAP-001 | 2026-07-18 | CF-HTFCAP-001 BTC+SOL binding (72) + ETH disclosure (36) = 108 | abbb1842 | **2022-07-14T00:00:00Z → 2023-07-12T14:24:00Z** (AMENDMENT-4 extended window) | **1747** (search, 12 restarts) | **10** (10 distinct terminals) | 0/72 cells net-positive (top-1 = selection artifact) | **1/2 (TEST spent)** | **EXPLORATORY — real sub-cost gross edge, NOT deployable (operator verdict 2026-07-19; re-analysed under INFR-016 report layers).** Operator-authorized deviation (AMENDMENT-4/5): majors' TRAIN-only (~1.4y) below LOW n_legs floor → **TRAIN+TEST window** (2022-07-14→2025-01-08=holdout_start; ~2.46y), n_legs_floor demoted to informative; **no reserved OOS → not a certification / not deployability.** Real gate-attributable sign-null-clearing GROSS edge on BTC `DI_ADX×VOL_HI adx25` H32/H64 (embargoed gross LCB +8..+18, sign p 0.02–0.05, collapse ~0.9) — hidden by the retired top-1 gate. **Net-of-cost 0/72 cells + 0 subsets resolve above zero** (~18 bps taker+GAP+funding wall at 8–16h holds; best net LCB −4.6). Estimand gate v2 PASS 108/108. HOLDOUT sealed (self-test PASS). Raw emission removed post-analysis (4.6G; regenerable; record in `results/`). Report `python/experiments/XENA-HTFCAP-001/report.md` | **CLOSED — CHARACTERISED** (not refuted — gross edge real; operator-signed 2026-07-19, checkpoint-013) |
