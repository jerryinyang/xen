...
- `CF-LIQSWP-001` — Liquidity Sweeps. **RETIRED — CHARACTERISED, NOT TRADABLE —
  2026-09-02, checkpoint-019.** Prior `REGISTERED` 2026-08-11. EXP-100 apparatus
  retained with ATR-undefined exclusion. EXP-101–104 leftover tables are winner-only;
  VAL-009–011 record that this is not the live-raid object. AMENDMENT-17 not computed.
  Causal online level/raid/sweep characterisation
