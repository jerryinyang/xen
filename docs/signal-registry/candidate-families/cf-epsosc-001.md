...
**Status:** `RETIRED — REFUTED` (2026-07-19, checkpoint-013 retrospective, operator-signed). Refuted twice at XENA: XENA-EPSOSC-001 (top-1 REJECT-class, AKRO single-symbol drift pedestal) and mass-aligned cross-symbol XENA-EPSOSC-002 (certified 4-symbol subset fails stage-2 gross LCB −68 AND derangement tripwire; **drift pedestal reproduced**). The apparent edge is volatility-window clustering, not the armed return-to-anchor signal. 0/2 gate slots; holdout SEALED. A genuinely new within-episode clearing object on unseen data = a **new family**, not a re-open. *(History: `REGISTERED` 2026-07-16 ckpt-013 D2; SPDR-005 WORTH_EXPLORING 2026-07-17.)*  
**Working name:** REF-B  
...
**Companions:**  
- SPDR pack: removed from live `docs/references/` (family closed; pack was SPDR-005 era)  
...
| 2026-07-16 | **SPDR-005 design.md COMPLETE** — STRETCH+VOLARM market-entry episodes; P-12 distinctness + P-10 (0 limit cells); L-16 episode-native primary; L-21 unit pin; L-27→INFR-014 battery forward-note; VR parallel facet; 0 slots / 0 reads; screen not started (`python/experiments/SPDR-005/design.md`) |
| 2026-07-17 | **SPDR-005 DISPOSITION: WORTH_EXPLORING (operator-signed)** — VOLARM×15m K≥3 cluster (23–25 cells, 4 symbols, both k & W, med lift +54–60 bps/episode, derangement collapse ≈0.95, floors cleared); VR facet not flat; GRID_TWIN not sole positive. Post-exec QA run 1 REVISE → operator-ratified AMENDMENTS 2–3 (fixed top-10 strata by full-TRAIN membership-days, LOOSER; seed tiering 25 primary/5 disclosure; ledger 1L/0T/2N). Caveats binding on XENA-EPSOSC-001: primary pooled median negative (−11.4/−9.2 bps — concentrated cluster, not broad availability); seed scope VOLARM×15m×{RET_ANCHOR,HYBRID}×k{2.5,3.0}×W{96,192} on cleared high-volume names (no BONK/BTT centring); causal universe selection via INFR-014; ~17-month effective window; L-27 next-open control for any limit-entry universe; XENA gate blocked on INFR-014 pin (`python/experiments/SPDR-005/analysis.md` §9) |
| 2026-07-18 | **XENA-EPSOSC-002 experiment verdict: NOT SUPPORTED (operator-signed, refuted)** — mass-aligned RET_ANCHOR cross-symbol redesign of 001. Estimand gate 152/152 PASS. AMENDMENT-1 (K≥3 distinct-symbol post-rank, TIGHTER) excluded the two 2-symbol raw finalists. Certified 4-symbol subset (10000LADYS_L, AKRO_S, LEVER_L, STMX_S): **stage-2 gross LCB −68.2 (net −102.1), 62 legs → does NOT certify**; **derangement tripwire FAIL** (raw collapse 0.091, drift-adjusted 0.135, live 95 < matched-drift twin P95 131.5). Per-symbol AKRO-concentrated (450 bps/10 legs carries pool; STMX −60, LEVER ~0) = **001 drift pedestal reproduced**; edge = volatility-window clustering, not arm→reversion signal. 0/2 gate slots, holdout SEALED. Evidence for a within-episode-clearing structure on single-name VOLARM fades is now negative across 001+002; **family status unchanged — checkpoint-level** (`python/experiments/XENA-EPSOSC-002/report.md`) |
| 2026-07-17 | **XENA-EPSOSC-001 experiment verdict: NOT SUPPORTED (analyst recommendation; superseded by 002)** — first VOLARM universe; top-1 REJECT-class (leak collapse 0.395); only survivor AKRO RET_ANCHOR dual short net-passes at seed=42 but on a directional-drift pedestal, single-symbol, seed-fragile, pre-mass search band. Motivated the mass-aligned 002 re-run. eval 2148 / 12 terminals; 0/2 slots; holdout sealed (`python/experiments/XENA-EPSOSC-001/analysis.md`) |
| 2026-07-19 | **RETIRED — REFUTED (checkpoint-013 retrospective, operator-signed).** Refuted twice at XENA (001 + mass-aligned 002); AKRO drift pedestal reproduced both times; edge = volatility-window clustering, not the arm-to-anchor mechanism. A new within-episode clearing object on unseen data = a new family, not a re-open. See `docs/experiments-docs/checkpoints/2026-07-16-013-chapter04-open-htfcap-epsosc-cal/retrospective.md` §4a |
