...
**Phase 004 — CF-MR-004 Cross-Domain MR Renewal — CONCLUDED 2026-07-03: CF-MR-004 RETIRED (EXP-014c CREDIBLE_NEGATIVE_RETIRE, audit PASS 0 Critical) → CF-MR-005 REGISTERED (spin-out).**
...
|--------|-----------|--------|
| CF-MR-005 — 4h ladder scale-in own-price MR harvest (basket-free trigger) | *(none yet)* | **REGISTERED (2026-07-03, EXP-014c spin-out).** Field evidence: 61 cells net ci_low>0 (53 non-admitted), all extend/allow arms, all 11 instruments (10 powered), year-stable 2021–24, 50–85% shift-surviving; ladder-depth P&L gradient. HYP-001 scoped as **EXP-015** (design gated APPROVE 2026-07-03; analysis-only mechanism characterisation, cost-stressed, native availability L-13, collapse-fraction controls W3; block-permute destroy L-07). `families/cf-mr-005/INDEX.md`, `candidate-families/cf-mr-005.md` |
