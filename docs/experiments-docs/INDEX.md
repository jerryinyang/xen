...
(2026-07-23). EXP-099 not authorised. Family retrospective still pending (independent of Ch.06).
...
- [`CF-VOLDIR-001`](../signal-registry/candidate-families/cf-voldir-001.md) — `REGISTERED`;
  checkpoint-017; `SPDR-012 → SPDR-013 → reflection → SPDR-014 → XENA-VOLDIR-001`; 0 counted reads.
- [`CF-VOLCONV-001`](../signal-registry/candidate-families/cf-volconv-001.md) — `REGISTERED`;
  checkpoint-016; SPDR-011 L1 closed NOT SUPPORTED; EXP-099 not authorised; 0 counted reads;
