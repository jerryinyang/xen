...
| Run-1 pre-exec QA | QA run 6 approved A9; the next blocked run exposed A10, which requires fresh QA |
| Run execution | Operator authorised a clean rerun after A10 implementation and fresh QA APPROVE |
...
| 4 | `SPDR-011` QA | Fresh-context design/code review | completed amended design + reviewable implementation | **PENDING — A10** |
...
The operator authorised A10 implementation, fresh QA and a clean Run-1 on 2026-07-23. Execution
may start only if that fresh review records APPROVE. A5–A10 form a six-amendment tighter streak and
