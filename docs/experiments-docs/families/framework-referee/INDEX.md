# Framework & Referee — Family Index

> Detailed per-experiment cards for the qualification-framework era (Phases 001–003b).
...
**Era:** CONCLUDED. Built and calibrated the 5-check gate-stack referee + the incremental/portfolio-fitness unit. Concluded suite: `{frozen strict gate stack, EXP-012 ratified-loose referee, EXP-018 revised incremental/fitness unit}`.
