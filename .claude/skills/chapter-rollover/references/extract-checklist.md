...
| `evaluation-framework.md` | The **frozen** referee/calibration suite — gate stack, adopted operating point, per-domain MDE maps, incremental/portfolio-fitness unit. State explicitly what must **not** be re-derived. |
